...
# class to convert WAV file to MIDI format
class Converter:
    ...
    def convert_file(file_in, file_out):
        ...
        matrix = Converter.build_transition_matrix(minimum_note, max_note, 0.9, 0.2)
        prob = Converter.calc_probabilities(y, minimum_note, max_note, sr, frame_length, window_length,
        ...
        # print(states)
        piano_format = Converter.convert_states_to_pianoroll(states, minimum_note, max_note, hop_length / sr)
        # print(pianoroll)
        midi_format = Converter.convert_pianoroll_to_midi(y, piano_format)
